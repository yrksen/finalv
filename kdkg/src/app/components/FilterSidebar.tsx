...
export function FilterSidebar({
  ...
  return (
    <aside className="w-full md:w-64 md:border-r-4 p-6" style={{ background: 'transparent' }}>
      {/* Try My Luck Button */}
      {onTryMyLuck && (
        <Button
          onClick={onTryMyLuck}
      ...
      <h2 className="text-xl font-semibold mb-6 hidden md:block dark:text-white">Filters</h2>

      <div className="mb-6">
        <h3 className="font-medium mb-3 dark:text-white">Year</h3>
        <div className="relative">
          <button
            onClick={() => setIsYearDropdownOpen(!isYearDropdownOpen)}
            className="w-full px-3 py-2 text-sm text-left border-2 rounded-md bg-white dark:bg-gray-700 dark:text-white dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
          >
                  ...
                  {years.map((year) => {
                    ...
                    return (
                      <button
                        ...
                        className={`relative py-2 px-2 text-sm rounded transition-colors ${
                          isSelected
      ...
      <div className="mb-6">
        <h3 className="font-medium mb-3 dark:text-white">Genre</h3>
      ...
      {onImdbRatingChange && imdbRatingRange && (
        <>
          <Separator className="my-6 dark:bg-gray-600" />
          <div className="mb-6">
            <h3 className="font-medium mb-3 dark:text-white">IMDb Rating</h3>
      ...
      {onRuntimeChange && runtimeFilter !== undefined && (
        <>
          <Separator className="my-6 dark:bg-gray-600" />
          <div className="mb-6">
            <h3 className="font-medium mb-3 dark:text-white">Runtime</h3>
            <div className="space-y-2">
              <button
                onClick={() => onRuntimeChange('all')}
                className={`w-full text-sm text-left py-1 px-2 rounded transition-colors ${
                  runtimeFilter === 'all' ? 'bg-blue-100 dark:bg-blue-600 text-blue-600 dark:text-white font-medium' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'
                }`}
              >
                All
              </button>
      ...
      {onTagChange && allTags && allTags.length > 0 && (
        <>
          <Separator className="my-6 dark:bg-gray-600" />
          <div className="mb-6">
            <h3 className="font-medium mb-3 dark:text-white">Tags</h3>
      ...
      {movies && movies.length > 0 && (
        <>
          <Separator className="my-6 dark:bg-gray-600" />
          <div className="mb-6">
            <h3 className="font-medium mb-3 dark:text-white">Top Rated (Your Ratings)</h3>
            <div className="space-y-2">
              {movies
        ...
        <>
          ...
          <div className="mb-6">
            <div className="flex items-center gap-2 mb-3">
              <MessageCircle className="size-4 dark:text-white" />
              <h3 className="font-medium dark:text-white">Recent Comments</h3>
            </div>
                ...
                .map((comment) => {
                  ...
                  return (
                    <button
                      ...
                      className="w-full text-left bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 p-3 rounded-lg border dark:border-gray-600 transition-colors"
                    >
